...
>(DefaultCrudRepository) {
  ...
  constructor(
    @inject('datasources.bonds') dataSource: BondsDataSource, @repository.getter('DocumentScreensRepository') protected documentScreensRepositoryGetter: Getter<DocumentScreensRepository>, @repository.getter('ScreensRepository') protected screensRepositoryGetter: Getter<ScreensRepository>,
  ) {
